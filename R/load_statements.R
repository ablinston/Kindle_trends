...
load_statements <- function(data_location){
  ...
  if (file.exists("private/saved_raw_statements.Rds")) {
    
    existing_data <- readRDS("private/saved_raw_statements.Rds")
  ...
  saveRDS(dataset,
          "private/saved_raw_statements.Rds")
